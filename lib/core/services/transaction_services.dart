...
class TransactionServices{
    ...
    void showTransactionDialog(
      BuildContext context, double amount, AccountItem accountItem,
      transactionType type,) {

    TransactionDialogSheet().displayDialog(
        context, accountItem,
        amount, type);
  }

  void executeTransaction(BuildContext context,AccountItem accountItem,transactionType type){
...
Navigator.pop(context);
  ...
  void withdrawAmount(BuildContext context, AccountItem accountItem)async {
      ...
      AccountItem updatedAccount = await api.makeWithdrawal(accountItem.id, amount);
